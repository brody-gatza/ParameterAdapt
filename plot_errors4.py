...
# These are intentionally different from, but visually related to, the raw colors.
MOVING_AVERAGE_COLORS = [
    "cyan",      # compliments blue
    "red",       # compliments orange
    "lime",      # compliments green
    "magenta",   # compliments purple
]
...
def plot_files(
    ...
    for ax, var_index in zip(axes, variable_indices):
        ...
        for file_idx, (filename, iterations, variables) in enumerate(loaded_data):
            ...
            if plot_moving_average:
                ...
                # Original signal
                # Plotted underneath the moving average.
                ax.plot(
                    x,
                    y,
                    color=raw_color,
                ...
                # Moving average
                # Plotted on top with a higher zorder.
                ax.plot(
                    x_avg,
                    y_avg,
                    color=ma_color,
    ...
    if plot_moving_average:
        figure_title = f"{figure_title} [moving average window = {moving_average_window}]"
