...
def in_progress_plot(fig,axs,x,FOM_prim_results,plot1,plot2,plot3,plot4,visual_var1,visual_var2,visual_var3,visual_var4,solver_param,iter):
    ...
    axs[0,0].set_ylim( 0 , max(y1)*1.1)
    axs[0,1].set_ylim( 0 , max(y2)*1.1)
    axs[1,0].set_ylim( 0 , max(y3)*1.1)
    axs[1,1].set_ylim( 0 , max(y4)*1.1)

    axs[0,0].set_xlim( 0 , x[-1]*1.1)
    axs[0,1].set_xlim( 0 , x[-1]*1.1)
    axs[1,0].set_xlim( 0 , x[-1]*1.1)
    axs[1,1].set_xlim( 0 , x[-1]*1.1)
