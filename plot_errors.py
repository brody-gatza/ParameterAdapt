...
class Settings:
    ...
    moving_average_windows: list[int] = field(default_factory=lambda: [25])
    baseline_moving_average_window: int = 100
    ...
    # ----------------------------
    plot_rolling_coefficient_of_variation: bool = True
    ...
    rolling_coefficient_of_variation_logy: bool = True
